...
public final class ModKeyBindings {
    public static final KeyMapping.Category BLOCKBEATS_CATEGORY = KeyMapping.Category.register(
            Identifier.fromNamespaceAndPath(BlockBeats.MOD_ID, "controls")
    );
