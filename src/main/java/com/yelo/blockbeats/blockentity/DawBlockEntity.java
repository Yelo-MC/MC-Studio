...
import com.yelo.blockbeats.item.BurnedDiscData;
import com.yelo.blockbeats.networking.OpenDawS2CPayload;
import com.yelo.blockbeats.screen.DawMenu;
...
public class DawBlockEntity extends BlockEntity implements Container, ExtendedScreenHandlerFactory<OpenDawS2CPayload> {
    ...
    @Override public Component getDisplayName() { return Component.translatable("container.blockbeats.daw"); }
